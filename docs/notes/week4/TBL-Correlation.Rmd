...
```
  ...
  2. Read Table 1 of [this paper](papers/Tosepu2020.pdf). Which variable is considered significantly correlated with the COVID19 cases count? What type of correlation is used in this paper? And why?
