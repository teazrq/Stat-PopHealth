...
## Practice questions 
  ...
  2. From Table 2 in [McLaughlin (2003)](papers/McLaughlin2003Extensive.pdf), we can also calculate the OR. Based on this information, can you directly calculate the OR of Left vs. Right (instead of Right vs. Left) and it confidence intervel?
