...
abstract: |
  This document was originally created by David Dalpiaz. The original file can be loaded from his [R4SL online text book](https://daviddalpiaz.github.io/r4sl/). I made some slight modifications. This is by no means a comprehensive guide, and there are many other resources available online. 
output:
  html_document: 
...
library(readr)
example_data = read_table("https://onlinecourses.science.psu.edu/stat501/sites/onlinecourses.science.psu.edu.stat501/files/data/skincancer/index.txt")
```
