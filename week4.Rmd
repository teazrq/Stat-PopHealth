...
## Reading Material
  ...
  * [[Correlation and Independence](notes/week4/TBL-Correlation.html)] [`.Rmd` `r xfun::embed_file('docs/notes/week4/TBL-Correlation.Rmd', text = 'Source File')`] 
  * [[Simple Linear Regression](notes/week4/TBL-SLR.html)] [`.Rmd` `r xfun::embed_file('docs/notes/week4/TBL-SLR.Rmd', text = 'Source File')`] [[Skin Cancer Data](data/skin.txt)]
  * [[Multiple Linear Regression and Confounding Variables](notes/week4/TBL-MLR.html)] [`.Rmd` `r xfun::embed_file('docs/notes/week4/TBL-MLR.Rmd', text = 'Source File')`]
  * We also use two papers as examples: [Gooding et al. (2011)](notes/week4/papers/Gooding2011.pdf) and [Tosepu et al. (2020)](notes/week4/papers/Tosepu2020.pdf)
  * If you have trouble with the `HistData` package, here is the [Cholera Data](notes/week4/Cholera.csv).

## Discussion Session

  * [High-dimensional Issues](notes/week4/TBL-HighDimension.html)