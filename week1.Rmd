...
## Lecture Note and R Examples
  ...
  + Lecture Note: [[Intro to Statistics](notes/intro/Intro to Stat.pdf){target='_blank'}]
  + Follow [this guide](rcode/week1/R-Intro.html){target='_blank'} to install R and RStudio __before class__
  + Download [`r xfun::embed_file('docs/rcode/week1/practice.Rmd', text = 'this .rmd file')`] for in-class practice
